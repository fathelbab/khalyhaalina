...
class _GovernateDropDownButtonState extends State<GovernateDropDownButton> {
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<CityProvider>(
      builder: (context, governorate, child) => Container(
          ...
          child: DropdownButton(
              ...
              onChanged: (dynamic newValue) {
                setState(() {
                  ...
                  locale == "ar"
                      ? governateId = governorate.governateList!
                ...
                saveNewValue(
                    context, governateId, _selectedGovernate.toString());
              },
              items: governorate.governateList!
                  .map(
                    (governate) => locale == "ar"
                        ? DropdownMenuItem(
